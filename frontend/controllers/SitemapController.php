...
class SitemapController extends Controller
{
    ...
    {
        return $this->renderSitemapWithCache('sitemap-index', function () {
    ...
    {
        return $this->renderSitemapWithCache('sitemap-pages', function () {
    ...
    {
        return $this->renderSitemapWithCache('sitemap-blog-categories', function () {
    ...
    {
        return $this->renderSitemapWithCache('sitemap-blog-posts-index', function () {
    ...
    {
        return $this->renderSitemapWithCache(['sitemap-blog-posts', $start], function () use ($start) {
    ...
    {
        return $this->renderSitemapWithCache('sitemap-shop-products-index', function () {
            return $this->sitemap->generateIndex(array_map(function ($start) {
    ...
    {
        return $this->renderSitemapWithCache(['sitemap-shop-products', $start], function () use ($start) {
    ...
    private function renderSitemapWithCache($key, callable $callback,
                                            Dependency $dependency = null): Response
    {
        return \Yii::$app->response->sendContentAsFile(\Yii::$app->cache->getOrSet($key, $callback, null, $dependency),
            Url::canonical(), [
