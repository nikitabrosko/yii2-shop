...
$this->params['breadcrumbs'][] = ['label' => 'Shopping Cart', 'url' => ['/shop/cart/cart']];
...
<div class="cabinet-index">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <?= $form->field($model->delivery, 'method')->dropDownList($model->delivery->deliveryMethodsList(), ['prompt' => 'Select', 'class' => 'form-select']) ?>
